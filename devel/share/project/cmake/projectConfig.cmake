...
if("TRUE" STREQUAL "TRUE")
  set(project_SOURCE_PREFIX /var/local/home/team11/ros_workspaces/final/src/project)
  set(project_DEVEL_PREFIX /var/local/home/team11/ros_workspaces/final/devel)
  set(project_INSTALL_PREFIX "")
  set(project_PREFIX ${project_DEVEL_PREFIX})
else()
  set(project_SOURCE_PREFIX "")
  set(project_DEVEL_PREFIX "")
  set(project_INSTALL_PREFIX /var/local/home/team11/ros_workspaces/final/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'team11 <team11@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/var/local/home/team11/ros_workspaces/final/src/project/${idir}'.  Ask the maintainer 'team11 <team11@todo.todo>' to fix it.")
    endif()
