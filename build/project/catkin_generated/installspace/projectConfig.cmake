...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/var/local/home/team11/ros_workspaces/final/install/${idir}'.  Ask the maintainer 'team11 <team11@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /var/local/home/team11/ros_workspaces/final/install/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/indigo/lib)
